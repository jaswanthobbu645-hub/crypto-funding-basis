...
SYMBOLS = [
    ...
    # Additional symbols to expand universe
    'TON/USDT:USDT', 'PEPE/USDT:USDT', 'WIF/USDT:USDT', 'BONK/USDT:USDT', 
    'FLOKI/USDT:USDT', 'ORDI/USDT:USDT', 'JUP/USDT:USDT', 'PYTH/USDT:USDT', 
    'WLD/USDT:USDT', 'STRK/USDT:USDT', 'BLUR/USDT:USDT', 'GMX/USDT:USDT',
    'DYDX/USDT:USDT', 'SNX/USDT:USDT', 'CRV/USDT:USDT', 'COMP/USDT:USDT', 
    'MKR/USDT:USDT', 'SUSHI/USDT:USDT', 'YFI/USDT:USDT', 'ENS/USDT:USDT', 
    '1INCH/USDT:USDT', 'LDO/USDT:USDT', 'RPL/USDT:USDT', 'PENDLE/USDT:USDT',
    'ETHFI/USDT:USDT', 'ENA/USDT:USDT', 'W/USDT:USDT', 'ZK/USDT:USDT', 
    'EIGEN/USDT:USDT', 'MOVE/USDT:USDT'
]
